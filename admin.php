  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link active" href="admin.php">Dashboard</a></li>
...
<section id="counts" class="counts  section-bg">
  ...
  <div class="box-container">
      ...
      <div class="box">
          ...
          <h4 class="price"><b>Request</b></h4>
            <a href="edit_request.php" class="btn">Modify</a>
      </div>
      
      <div class="box">
          <img src="images/donation.png" alt="">
          <h4 class="price"><b>Pet</b></h4>
            <a href="edit_pet.php" class="btn">Modify</a>
      </div>

      <div class="box">
          <img src="images/volunteer.png" alt="">
          <h4 class="price"><b>Volunteer</b></h4>
            <a href="edit_volunteer.php" class="btn">Modify</a>
      </div>
      
      <div class="box">
          <img src="images/lost.png" alt="">
          <h4 class="price"><b>News</b></h4>
            <a href="edit_news.php" class="btn">Modify</a>
      </div>
