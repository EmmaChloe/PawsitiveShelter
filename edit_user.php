  ...
  <section class="pricing" id="pricing">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h4 class="price"><b>Admin</b></h4>
            <p>Modify administrators details</p>
              <a href="edit_admin.php" class="btn">Manage</a>
        </div>
  
        <div class="box">
            <img src="images/public.png" alt="">
            <h4 class="price"><b>Public</b></h4>
            <p>Modify public details</p>
              <a href="edit_public.php" class="btn">Manage</a>
        </div>
