      ...
      <div class="row">
          ...
          <?php
                if (isset($_GET['signup']) && $_GET['signup'] === 'success') {
                    echo '<div class="success-message">Add new admin successful!</div>';
                }
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($pagination_result) > 0) {
                            while ($user_details = mysqli_fetch_assoc($pagination_result)) {
                                // Add a condition to check if the user type is 'Admin'
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this admin? <br> This action cannot be undone and you will be unable to recover any data.</p>
                </div>
...
<script>
    $(document).ready(function() {
        $('#editmodal').on('show.bs.modal', function (event) {
            ...
            $('#edit_userType').val(User_Type === 'Admin' ? 'User' : 'Admin');
        });
    });
  </script>
        ...
        <div class="modal-content">
            ...
            <form method="post" action="add_admin.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="addadmin" class="btn btn-danger">Submit</button>
                </div>
            </form><!-- End Profile Edit Form -->
        </div>
    </div>
