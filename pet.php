...
if (isset($_GET['pet_id'])) {
    ...
    $fetch_pet_query = "SELECT * FROM Pet WHERE Pet_ID = $pet_id";
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="portfolio-description">
                        ...
                        <center><h2>For Adoption</h2></center>
                        <p>
                            <?php echo $pet_details['Pet_Description']; ?>
                        </p>
                    </div>
                    <center>
                        <!-- Link to initiate the adoption process -->
                        <a href="process_adoption.php?pet_id=<?php echo $pet_details['Pet_ID']; ?>" class="btn">Adopt</a> <br>
                    </center>
                </div>
