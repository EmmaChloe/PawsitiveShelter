...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($volunteerCV['error'] == UPLOAD_ERR_OK) {
        ...
        if (!is_writable(__DIR__ . '/cv/')) {
            ...
            header("Location: volunteer.php?error=directorynotwritable");
            exit();
        }
        ...
        if (move_uploaded_file($cv_temp, $cvFolder)) {
            ...
            header("Location: volunteer.php?error=filemovefailed");
            exit();
        }
    } else {
        // Handle file upload error
        header("Location: volunteer.php?error=fileuploadfailed");
        exit();
    }
}
